...
return_range = (85,98,1)
vol_low_range = (2,16,1)
vol_high_range = (16,35,1)

print(tester.optimize_strategy(return_range, vol_low_range, vol_high_range))
...
tester.test_strategy((92,13,34))
tester.plot_results()

return_thresh = tester.return_thresh
print(f"return tresh: {return_thresh}")
vol_thresh = tester.volume_thresh
print(f"vol_thresh: {vol_thresh}")

print(tester.test_strategy(thresh=(return_thresh, vol_thresh[0], vol_thresh[1])))

tester.plot_results()

print(tester.results.position.value_counts())
