...
print(tester)
print(tester.data)
print(tester.test_strategy(percentiles=(90,5,20)))
...
print(tester.test_strategy(thresh= (return_thresh, volume_thresh[0], volume_thresh[1])))

return_range = (85,98,1)
vol_low_range = (2,16,1)
vol_high_range = (16,35,1)
print("*" * 150)
tester.optimize_strategy(return_range, vol_low_range, vol_high_range)
print("*" * 150)
print(tester.results_overview.nlargest(20, "performance"))
print("*" * 150)
print(tester.results)
tester.plot_results()